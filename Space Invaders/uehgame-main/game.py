...
class Game:
    def __init__(self, screen_width, screen_height, offset):
        ...
        self.score = 0
        self.highscore = 0
        self.mystery_ship_boom = pygame.mixer.Sound("sounds/lamhet.ogg")
        self.alien_boom = pygame.mixer.Sound("sounds/lamkon.ogg")
        self.load_highscore()
        pygame.mixer.music.load("music/feinlow.ogg")
